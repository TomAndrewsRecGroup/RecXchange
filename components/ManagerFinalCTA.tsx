    ...
    <section className="mt-20 py-16 border-t border-cyan-400/10 relative">
      ...
      >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          className="inline-flex items-center gap-3 px-10 py-5 rounded-full bg-gradient-to-r from-fuchsia-500 to-cyan-500 text-white font-bold text-base shadow-[0_0_25px_rgba(255,0,255,0.25)] relative z-10"
        >
