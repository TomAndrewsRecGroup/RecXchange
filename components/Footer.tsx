...
export default function Footer() {
  return (
    <footer className="bg-[#050508] border-t border-cyan-400/20 pt-16 pb-8 relative z-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12">
        <div className="col-span-2">
          <Link href="/">
            <Image
              ...
              alt="RecXchange Logo - Recruiter Collaboration Platform" width={140} height={35}
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-500">
            ...
            <li><Link href="/legal" className="hover:text-cyan-400 transition-colors">Legal Information</Link></li>
          </ul>
        </div>
      </div>

      {/* NEW: Contextual Links Section Above Copyright */}
      <div className="max-w-7xl mx-auto px-6 mt-12 pt-8 border-t border-cyan-400/10">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-8 pt-8 border-t border-cyan-400/10 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-600 text-xs">
