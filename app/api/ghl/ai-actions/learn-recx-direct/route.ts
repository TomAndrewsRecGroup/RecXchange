 ...
 * 
 * Called by: GHL AI Agent when recruiter asks about RecX Direct
 * 
 * Webhook URL: https://recxchange.io/api/ghl/ai-actions/learn-recx-direct
 * Method: POST
 * 
...
export async function POST(req: NextRequest) {
  console.log('[GHL AI Action] Learn RecX Direct webhook triggered');
...
Learn more: https://recxchange.io/why-recxchange
    ...
    if (contactId && conversationId) {
      try {
        ...
        console.error('[GHL AI Action] Failed to send info message:', msgError);
      }
    }
