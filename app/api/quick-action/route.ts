                      ...
                      <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: linear-gradient(135deg, rgba(168, 85, 247, 0.12) 0%, rgba(59, 130, 246, 0.08) 100%); border: 2px solid rgba(168, 85, 247, 0.4); border-radius: 16px; margin-bottom: 24px;">
                        <tr>
                          <td style="padding: 32px 28px;">
                            ...
                            <p style="color: #fff; font-size: 17px; line-height: 1.8; margin: 0 0 16px 0; font-weight: 700;">RecX Direct is our revolutionary fee-pooling subscription model that flips traditional recruitment pricing on its head.</p>
                            ...
                            <p style="color: #ddd; font-size: 15px; line-height: 1.7; margin: 0 0 24px 0;"><strong style="color: #fff;">The RecX Direct Way:</strong> Pay one flat monthly subscription. Make <em>unlimited placements</em> from the shared fee pool. Predictable costs. Zero per-hire fees. Insane ROI.</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: rgba(0, 0, 0, 0.5); border: 1px solid rgba(168, 85, 247, 0.4); border-radius: 16px; padding: 24px; margin-bottom: 24px;">
                              <tr>
                                <td style="text-align: center;">
                                  <p style="color: #888; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; margin: 0 0 12px 0;">🏆 Current Active Fee Pool</p>
                            ...
                            <h3 style="color: rgb(168, 85, 247); font-size: 18px; font-weight: 700; margin: 0 0 16px 0;">How Does the Fee Pool Work?</h3>
                            <p style="color: #ccc; font-size: 14px; line-height: 1.7; margin: 0 0 16px 0;">Companies hiring regularly contribute to a shared fee pool based on their subscription tier. When you make a hire, the fee comes from the pool—not from a per-hire invoice. You're pre-paying for recruitment capacity, not individual placements.</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background: rgba(168, 85, 247, 0.05); border: 1px solid rgba(168, 85, 247, 0.2); border-radius: 12px; margin-bottom: 16px;">
                              <tr>
                                <td style="padding: 20px;">
                                  ...
                                  <p style="color: #ccc; font-size: 14px; line-height: 1.7; margin: 0;">For agencies and high-volume recruiters. Unlimited roles + candidates. 70/30 split options on premium roles. Advanced analytics dashboard. Dedicated account manager. RecX Direct pool access.</p>
                                </td>
                              </tr>
                            </table>
