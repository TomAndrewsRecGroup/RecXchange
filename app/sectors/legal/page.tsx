...
import { Scale, BookOpen, Shield, Globe, ArrowRight } from 'lucide-react';
import FuturisticBackground from '@/components/design-system/FuturisticBackground';
import HolographicCard from '@/components/design-system/HolographicCard';
import StatusBadge from '@/components/design-system/StatusBadge';
import NeonDivider from '@/components/design-system/NeonDivider';

export default function LegalSectorPage() {
  const specialisms = [
    { icon: Scale, color: "purple" as const, name: "Private Practice", roles: "Solicitors (all PQE), associates, senior associates, partners, legal directors", regions: "UK, USA, UAE, Hong Kong, Singapore" },
    { icon: BookOpen, color: "cyan" as const, name: "In-House & Counsel", roles: "In-house counsel, general counsel, deputy GC, legal directors, corporate legal managers", regions: "UK, USA, Ireland, UAE, Australia" },
    { icon: Shield, color: "fuchsia" as const, name: "Compliance & Regulatory", roles: "Compliance officers, MLRO, regulatory lawyers, financial crime compliance", regions: "UK, Luxembourg, USA, UAE, Singapore" },
    { icon: Globe, color: "purple" as const, name: "Paralegals & Support", roles: "Paralegals, legal executives, legal PAs, knowledge lawyers, trainee solicitors", regions: "UK, Ireland, USA, Canada" }
  ];
  return (
