...
export const metadata: Metadata = {
  ...
  description: "Live HR recruitment split fee roles on RecXchange. HR directors, HR business partners, talent acquisition, L&D, HR managers, and people operations roles across UK, USA, Europe.",
