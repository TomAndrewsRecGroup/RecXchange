...
export const metadata: Metadata = {
  ...
  description: "Live sales split fee roles on RecXchange. Account executives, BDMs, sales directors, SDRs, enterprise sales, SaaS and commercial roles. UK, USA, Europe.",
