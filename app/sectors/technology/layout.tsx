...
export const metadata: Metadata = {
  ...
  description: "Browse live technology split fee roles on RecXchange. Software engineers, DevOps, data science, cybersecurity, product management, and CTO-level roles. UK, USA, Europe, Asia Pacific. Submit candidates and split fees with specialist tech recruiters.",
