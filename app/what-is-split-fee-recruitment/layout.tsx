...
export const metadata: Metadata = {
  ...
  description: "Split fee recruitment is where two recruiters collaborate on a placement and share the fee. One holds the role, one has the candidate. Both earn. Learn how it works, what the splits look like, and why 15,000+ recruiters use RecXchange to split fees safely.",
  keywords: [
