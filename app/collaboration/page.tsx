          ...
          <section className="mb-8 sm:mb-12 md:mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <HolographicCard color="purple" variant="content">
                ...
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-4 sm:mb-5 md:mb-6 mt-4">
                ...
                <div className="space-y-4 text-gray-300 text-[13px] sm:text-sm md:text-base leading-relaxed">
                  ...
                  <p>
                    He looked. He searched. And what he found either didn&apos;t feel right, or it was so clunky and inefficient it was clear it had been <strong className="text-white">built by technologists who thought they understood recruitment — but clearly didn&apos;t.</strong>
                  </p>
                  <p>
              ...
              <HolographicCard color="cyan" variant="content">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                  <div className="p-4 rounded-xl bg-cyan-400/5 border border-cyan-400/20">
                    <div className="text-cyan-400 font-bold text-sm mb-1 uppercase tracking-wider">Tom Andrews</div>
                  ...
                  <div className="p-4 rounded-xl bg-fuchsia-400/5 border border-fuchsia-400/20">
                    <div className="text-fuchsia-400 font-bold text-sm mb-1 uppercase tracking-wider">James Brown</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <HolographicCard color="cyan" variant="content">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3 sm:mb-4 mt-4">When to Keep the Full Fee</h3>
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <HolographicCard color="fuchsia" variant="content">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3 sm:mb-4 mt-4">When to Bring in a Partner</h3>
                  <p className="text-gray-300 text-[13px] sm:text-sm leading-relaxed mb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6">
              <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <HolographicCard color="purple" variant="content">
                  ...
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3">The Relationship-Led Recruiter</h3>
                  <p className="text-gray-300 text-[13px] sm:text-sm leading-relaxed mb-4">
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                <HolographicCard color="cyan" variant="content">
                  <div className="text-4xl mb-4">🎯</div>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-3">The World-Class Sourcer</h3>
                  <p className="text-gray-300 text-[13px] sm:text-sm leading-relaxed mb-4">
            ...
            <HolographicCard color="fuchsia" variant="content" glowIntensity="high">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 md:gap-6 mb-8">
                {[
                  ...
                  <HolographicCard key={i} color={item.color as any} variant="feature">
                    <div className="text-3xl mb-3">{item.emoji}</div>
                    <h3 className="text-white font-bold text-base mb-2">{item.who}</h3>
          ...
          <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="my-8 sm:my-12 md:my-16">
            <HolographicCard color="purple" variant="content" glowIntensity="high" className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                ...
                <GlowButton variant="ghost" size="lg" href="/why-recxchange">Why RecXchange?</GlowButton>
              </div>
            </HolographicCard>
          </motion.section>
