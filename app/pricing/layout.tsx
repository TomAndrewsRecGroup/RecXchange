...
export const metadata: Metadata = {
  ...
  description: "RecXchange pricing starts at $1/month. Choose Entry ($1), Lite ($99), Pro ($249), or Teams (custom). One placement pays for 5-12 months. No platform fees on placements. Access 15,000+ recruiters and 270M candidates.",
  keywords: [
    "recruiter pricing",
  ...
  openGraph: {
    ...
    description: "One placement pays for the year. Entry $1, Lite $99, Pro $249. No platform fees on placements.",
