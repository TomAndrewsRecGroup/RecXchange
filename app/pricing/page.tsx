...
export default function PricingPage() {
  return (
    <div className="py-20 px-6">
      ...
      {/* Split Fee Section */}
      <section className="max-w-4xl mx-auto mt-32 p-12 glass-card rounded-3xl text-center border-cyan-400/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="text-fuchsia-400 font-bold text-2xl mb-1">RecXDirect</div>
