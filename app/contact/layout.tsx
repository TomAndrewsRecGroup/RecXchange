...
export const metadata: Metadata = {
  ...
  description: 'Have questions about RecXchange? Contact our team for support, partnership inquiries, or platform information. We're here to help recruiters and hiring managers succeed.',
