...
export const metadata: Metadata = {
  title: "Scale-Up Hiring | Recruit Fast Without a Retainer | RecXchange",
  description: "RecXchange is built for scale-ups hiring fast. No retainers, no exclusivity, no agency lock-in. Access 15,000+ specialist recruiters via the Xchange Engine. Post a role, receive top 1% candidates within 48 hours. Pay only on placement. Scale your team without scaling your recruitment costs.",
  keywords: [
    ...
    <>
      ...
      <main className="relative bg-[#0a0a0f] min-h-screen">
        <div className="max-w-4xl mx-auto px-6 py-24">
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            Post your role on RecXchange with a brief, salary range, and location. The Xchange Engine immediately matches it to specialist recruiters across the relevant sector and geography. Within 48–72 hours, pre-screened candidate submissions begin arriving — each reviewed by your dedicated Account Manager who filters to top 1% quality before anything reaches your inbox. No CV sifting. No agency management. Just hires.
          </p>
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            Scale-up cash management is critical. RecXchange charges nothing until a candidate accepts an offer — a 12–20% success fee on the agreed salary. No retainers eating into runway. No monthly platform fees. No wasted spend on searches that don't convert. For funded scale-ups managing burn rate, the pure success-fee model is a material commercial advantage over every retainer or subscription-based alternative.
          </p>
