...
export const metadata: Metadata = {
  ...
  description: "RecXchange for senior and executive hiring: access specialist executive recruiters across Leadership, C-Suite, VP, Director and Head-of level roles. No retainer. No exclusivity. A single success fee of 12–20% payable only when your senior hire accepts an offer.",
  keywords: [
  ...
  openGraph: {
    title: "Senior & Executive Search | No Retainer | RecXchange",
    description: "Executive recruiter networks. No retainer. No exclusivity. 12–20% success fee. Pay only when your senior hire accepts.",
      ...
      <main className="relative bg-[#0a0a0f] min-h-screen">
        <div className="max-w-4xl mx-auto px-6 py-24">
          ...
          <p className="text-gray-300 text-lg mb-10 leading-relaxed">
            Senior and executive hires carry the highest stakes and the highest fees. Traditional retained search firms charge 30–35% with a significant upfront retainer — payable whether or not a placement is made. RecXchange gives you access to boutique executive and senior specialist recruiters across every function and sector, with a pure success fee model and no retainer required.
          </p>
          ...
          <div className="mt-12 p-6 rounded-2xl border border-cyan-400/20 bg-cyan-400/5">
            ...
            <p className="text-gray-300 text-sm">Access boutique executive recruiters across every sector. No upfront cost. No exclusivity. 12–20% success fee payable only when your senior hire accepts an offer.</p>
          </div>
        </div>
      </main>
    </>
