...
export const metadata: Metadata = {
  title: "Split Fee Recruitment UAE | Recruiter Marketplace | RecXchange",
  description: "Split fee recruitment marketplace for UAE and Middle East recruiters. Partner with specialist recruiters across Dubai, Abu Dhabi and the GCC. Engineering, Healthcare, Finance, Technology and Construction roles. RecXchange connects MENA recruiters globally.",
  keywords: [
