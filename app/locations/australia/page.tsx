...
export const metadata: Metadata = {
  title: "Split Fee Recruitment Australia | Recruiter Marketplace | RecXchange",
  description: "Split fee recruitment marketplace for Australian recruiters. Partner with 15,000+ specialist recruiters across Sydney, Melbourne, Brisbane and beyond. Engineering, Healthcare, Technology, Mining and Finance roles. Average $7,000 per split placement.",
  keywords: [
