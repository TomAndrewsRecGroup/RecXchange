...
const faqs: FAQItem[] = [
  ...
  { category: "Tokens & Pricing", color: "fuchsia", question: "What happens if I run out of tokens?", answer: "You can purchase additional token packs inside the platform: 10 tokens for $10, 50 tokens for $40, 100 tokens for $70, or 500 tokens for $300. You can also upgrade to a higher tier for a larger monthly allocation." },
