...
const faqs: FAQItem[] = [
  ...
  { category: "Getting Started", color: "purple", question: "How much does it cost?", answer: "Entry tier is $1/month (5 tokens). Lite is $99/month (150 tokens). Pro is $250/month (400 tokens). Teams is custom pricing for agencies with 5+ recruiters. One placement typically pays for 5-12 months of membership." },
