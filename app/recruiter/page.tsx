    ...
    <main className="relative min-h-screen flex flex-col items-center pt-16 sm:pt-20 md:pt-28 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1200px] flex flex-col items-center">
        ...
        <footer className="mt-10 sm:mt-12 md:mt-16 w-full px-2">
          <div className="glass-card py-2.5 sm:py-3 md:py-4 px-3 sm:px-6 md:px-10 rounded-full border-cyan-400/10 flex flex-col md:flex-row justify-between items-center gap-2.5 sm:gap-3 md:gap-4 text-[8px] sm:text-[9px] text-gray-500 font-bold uppercase tracking-[0.12em] sm:tracking-[0.15em] md:tracking-[0.2em]">
