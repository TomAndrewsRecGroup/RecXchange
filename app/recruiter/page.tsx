    ...
    <main className="relative min-h-screen flex flex-col items-center pt-24 md:pt-32 pb-12 md:pb-20 px-4 sm:px-6 overflow-x-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1200px] flex flex-col items-center">
        <header className="text-center mb-8 md:mb-12">
          ...
          >
            <span className="block text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-cyan-400/60 mb-4 md:mb-6 font-bold">
        ...
        {/* Diagnostic Card */}
        <section className="glass-card w-full rounded-2xl sm:rounded-[2.5rem] md:rounded-[3rem] p-6 sm:p-8 md:p-10 lg:p-14 border-cyan-400/10 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/5 blur-[100px] pointer-events-none" />

          <div className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-cyan-400/20 bg-cyan-400/5 text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-cyan-400 mb-6 md:mb-8">
            Select your path
          </div>
            ...
            <Link href="/recruiter-roles" className="group">
              ...
              >
                <div>
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 group-hover:text-cyan-400 transition-colors">I need candidates</h3>
                ...
                <div className="relative w-full py-3 sm:py-4 rounded-xl border border-white/15 bg-black/40 overflow-hidden group/btn text-[10px] sm:text-[11px] font-bold uppercase tracking-wider sm:tracking-widest text-center transition-all">
            ...
            <Link href="/recruiters-with-candidates" className="group">
              ...
              >
                <div>
                  ...
                  <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 group-hover:text-fuchsia-400 transition-colors">I need roles</h3>
                  <p className="text-gray-500 text-sm leading-relaxed mb-6 sm:mb-8">
          ...
          <div className="mt-10 sm:mt-12 md:mt-14 pt-8 sm:pt-10 border-t border-cyan-400/10 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6 text-[10px] sm:text-[11px] text-gray-500">
            ...
            <Link href="/pricing" className="text-cyan-400 hover:text-white transition-colors font-bold uppercase tracking-wider sm:tracking-widest flex items-center gap-2 text-[10px] sm:text-[11px]">
              Review Membership Tiers <span className="text-base sm:text-lg">→</span>
            </Link>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-10 sm:mb-12 md:mb-16">
            ...
            <div className="glass-card p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] md:rounded-[2.5rem] border-cyan-400/10 relative overflow-hidden">
              ...
              <div className="relative">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-cyan-400">If You Need Candidates</h3>
            ...
            <div className="glass-card p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] md:rounded-[2.5rem] border-fuchsia-400/10 relative overflow-hidden">
              ...
              <div className="relative">
                <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-fuchsia-400">If You Need Roles</h3>
                <p className="text-gray-400 text-sm leading-relaxed mb-6 sm:mb-8">
        ...
        <section className="mt-12 sm:mt-16 md:mt-20 w-full glass-card rounded-2xl sm:rounded-[2.5rem] md:rounded-[3rem] p-6 sm:p-8 md:p-10 lg:p-14 border-cyan-400/10 text-center">
          <div className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 rounded-full border border-cyan-400/20 bg-cyan-400/5 text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-cyan-400 mb-4 sm:mb-6">
            Quick Start
          </div>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-3 sm:mb-4">Want to see live roles?</h2>
        ...
        <section className="mt-12 sm:mt-16 md:mt-20 w-full space-y-6 sm:space-y-8">
          ...
          <div className="glass-card p-6 sm:p-8 rounded-2xl sm:rounded-3xl border-cyan-400/10">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">How much can I earn on RecXchange?</h3>
          ...
          <div className="glass-card p-6 sm:p-8 rounded-2xl sm:rounded-3xl border-cyan-400/10">
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4">How does the 70% split on RecX Direct work?</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
        ...
        <footer className="mt-12 sm:mt-16 w-full px-4">
