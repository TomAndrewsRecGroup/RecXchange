      ...
      <div className="relative z-10 text-center max-w-[1200px] w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 w-full mx-auto">
          ...
          <motion.div
            ...
            className="glass-card p-6 sm:p-8 md:p-10 lg:p-12 rounded-xl sm:rounded-2xl md:rounded-[2.5rem] lg:rounded-[3rem] flex flex-col justify-between items-start text-left min-h-[420px] sm:min-h-[450px] md:min-h-[480px] cursor-pointer group relative overflow-hidden"
          >
