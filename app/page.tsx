      ...
      <main className="relative bg-[#0a0a0f] font-[family-name:var(--font-lexend)] overflow-hidden">
        ...
        <section className="relative h-screen flex flex-col items-center justify-center px-4 pt-20" aria-label="Hero section">
          ...
          <header className="relative z-10 max-w-5xl mx-auto text-center" style={{ perspective: '1000px' }}>
            ...
            {/* Futuristic CTA Button - softened glow */}
            <motion.div
            ...
            >
              ...
              >
                ...
                <span className="absolute -inset-3 bg-gradient-to-r from-cyan-500 via-purple-500 to-fuchsia-500 rounded-2xl blur-2xl opacity-15 group-hover:opacity-30 animate-pulse-slow pointer-events-none" aria-hidden="true" />
                <span className="absolute -inset-1.5 bg-gradient-to-r from-cyan-500 via-purple-500 to-fuchsia-500 rounded-xl blur-xl opacity-20 group-hover:opacity-35 transition-opacity pointer-events-none" aria-hidden="true" />
                ...
                <span className="relative flex items-center gap-2 sm:gap-3 px-8 sm:px-10 py-3 sm:py-4 bg-gradient-to-r from-cyan-500 via-purple-500 to-fuchsia-500 rounded-xl font-black text-sm sm:text-base text-white group-hover:scale-105 transition-all duration-300"
                  style={{
                    boxShadow: '0 0 20px rgba(0,240,255,0.3), inset 0 1px 0 rgba(255,255,255,0.3)'
                  }}
                >
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-6xl w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-full mx-auto max-w-5xl px-4" style={{ perspective: '2000px' }} role="list">
              ...
              >
                {/* Softened underglow */}
                <div className="absolute -inset-1 bg-gradient-to-br from-cyan-500/20 via-cyan-600/10 to-cyan-500/20 rounded-[3rem] blur-xl opacity-30 group-hover:opacity-50 transition duration-500 pointer-events-none" aria-hidden="true" />
              ...
              <motion.article
                ...
                role="listitem"
              >
                <div className="absolute -inset-1 bg-gradient-to-br from-fuchsia-500/20 via-pink-600/10 to-fuchsia-500/20 rounded-[3rem] blur-xl opacity-30 group-hover:opacity-50 transition duration-500 pointer-events-none" aria-hidden="true" />
