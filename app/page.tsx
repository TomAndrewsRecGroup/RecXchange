...
export default function RootPage() {
  ...
  const handleWebsiteClick = (e: React.MouseEvent) => {
    ...
    setTimeout(() => {
      router.push('/home');
    }, 600); // Increased for smoother fade
  };
  ...
  return (
    <>
      {/* Fade Overlay - mimics initial fade */}
      <AnimatePresence>
        {isNavigating && (
          <motion.div
            initial={{ opacity: 0 }}
      ...
      <main className="relative min-h-screen bg-black flex flex-col items-center px-4 sm:px-6 py-12 sm:py-16 overflow-x-hidden">
        {/* Single container for logo - no layout shift */}
        <div className="w-full max-w-[1200px] mx-auto">
          ...
          <motion.p
            ...
            className="text-white text-sm sm:text-base md:text-xl font-light tracking-wide text-center mb-12 sm:mb-16 max-w-5xl mx-auto px-4"
          >
          ...
          <motion.div
            ...
            className="relative z-10 mb-16 sm:mb-20 md:mb-24"
          >
