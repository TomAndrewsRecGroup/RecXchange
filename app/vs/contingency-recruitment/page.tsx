...
export const metadata: Metadata = {
  ...
  description: "RecXchange vs contingency recruitment: skip multi-agency chaos. One platform, split fee agreements, deal protection, Account Manager. Pay on hire.",
  keywords: [
