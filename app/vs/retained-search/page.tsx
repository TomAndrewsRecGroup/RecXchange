...
export const metadata: Metadata = {
  ...
  description: "RecXchange vs retained search and executive search firms: retained search costs 30–35% of salary with 30–50% upfront. RecXchange delivers senior candidate quality from specialist recruiters with no retainer, no exclusivity, and a success fee payable only on placement.",
  keywords: [
  ...
  openGraph: {
    title: "RecXchange vs Retained Search | Executive Search Alternative",
    description: "Retained search costs 30–35% + upfront retainer. RecXchange: senior candidate quality, no retainer, pay only on placement.",
  ...
  twitter: { card: "summary_large_image", title: "RecXchange vs Retained Search", description: "Retained search = 30–35% + upfront retainer. RecXchange = senior quality, no retainer, pay only on placement.", images: ["https://haaqtnq6favvrbuh.public.blob.vercel-storage.com/REX-Icon-GW-Small-25.png"], creator: "@RecXchange" }
};
          ...
          <div className="mt-12 overflow-x-auto">
            <table className="w-full text-sm text-left border-collapse">
              ...
              <tbody className="text-gray-300">
                {[
                  ["Fee %", "12–20% success only", "30–35% total"],
                  ["Upfront cost", "None", "30–50% of total fee"],
                  ...
                  ["Timeline to shortlist", "48–72 hours first submissions", "4–8 weeks"],
