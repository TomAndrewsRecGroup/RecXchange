...
export const metadata: Metadata = {
  ...
  description: "RecXchange vs RPO (Recruitment Process Outsourcing). RPO requires long contracts, embedded teams, and high fixed costs. RecXchange delivers RPO-quality outcomes — dedicated Account Manager, managed process, top 1% candidates — with no contract lock-in and zero upfront cost.",
  keywords: [
    "RecXchange vs RPO",
    "RPO alternative",
          ...
          <div className="mt-12 overflow-x-auto">
            <table className="w-full text-sm text-left border-collapse">
              ...
              <tbody className="text-gray-300">
                {[
                  ["Contract required", "No", "Yes — 12–24 months"],
                  ...
                  ["Best for", "1–20 specialist hires/year", "50+ volume hires/year"],
