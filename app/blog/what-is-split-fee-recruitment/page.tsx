...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "split placement guide",
    "recruiter fee split percentage",
    "split fee recruitment UK",
    "split placement definition",
    "recruiter collaboration fee split"
  ],
  alternates: { canonical: "https://recxchange.io/blog/what-is-split-fee-recruitment" },
  openGraph: {
    title: "What Is Split Fee Recruitment? The Complete Guide",
    description: "Split fee recruitment explained: how it works, fee percentages, who benefits, and how RecXchange makes it seamless.",
    url: "https://recxchange.io/blog/what-is-split-fee-recruitment",
    type: "article",
    images: [{ url: "https://haaqtnq6favvrbuh.public.blob.vercel-storage.com/REX-Icon-GW-Small-25.png", width: 1200, height: 630, alt: "What Is Split Fee Recruitment" }]
  },
  twitter: { card: "summary_large_image", title: "What Is Split Fee Recruitment? The Complete Guide", description: "Split fee recruitment explained: how it works, fee percentages, who benefits.", images: ["https://haaqtnq6favvrbuh.public.blob.vercel-storage.com/REX-Icon-GW-Small-25.png"], creator: "@RecXchange" }
};
...
export default function WhatIsSplitFeeRecruitmentPage() {
  const articleSchema = {
    ...
    "@type": "Article",
    "@id": "https://recxchange.io/blog/what-is-split-fee-recruitment#article",
    "url": "https://recxchange.io/blog/what-is-split-fee-recruitment",
    ...
    "mainEntityOfPage": { "@type": "WebPage", "@id": "https://recxchange.io/blog/what-is-split-fee-recruitment" },
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "What Is Split Fee Recruitment?", "item": "https://recxchange.io/blog/what-is-split-fee-recruitment" }
      ]
    }
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "What percentage is a typical split fee?",
        "acceptedAnswer": { "@type": "Answer", "text": "The most common split fee arrangement is 50/50, where both recruiters share the placement fee equally. On RecXchange's RecX Direct product, the candidate-holding recruiter takes 70% of the total fee. Split percentages can also be 60/40 depending on the agreed terms between the two parties." }
      },
      {
        "@type": "Question",
        "name": "Is split fee recruitment legal in the UK?",
        "acceptedAnswer": { "@type": "Answer", "text": "Yes. Split fee recruitment is entirely legal in the UK and is a widely practised model within the professional recruitment industry. The arrangement is governed by a split fee agreement between the two recruiting parties, which defines the fee percentage, payment terms, candidate ownership, and any deal protection provisions." }
      }
    ]
  };
    ...
    <>
      ...
      <main className="relative bg-[#0a0a0f] min-h-screen">
        <div className="max-w-3xl mx-auto px-6 py-24">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-white mb-6">What Is Split Fee Recruitment?</h1>
          ...
          <div className="mt-12 p-6 rounded-2xl border border-cyan-400/20 bg-cyan-400/5">
            ...
            <p className="text-gray-300 text-sm">Join RecXchange as a recruiter and start collaborating on live roles from global hiring managers. Or post a role as a hiring manager and activate 15,000+ specialist recruiter networks instantly.</p>
          </div>
        </div>
      </main>
    </>
